...
public class Lexico {
						...
						if(c == 'l' || c == 'g' || c == 'e' || c == 'd') {
							...
							if(c == 't' || c == 'e' || c == 'q' || c == 'f') {
								...
								if(c == ';') {
									...
									if(c != ';') {
										throw new ExcecaoLexica(c , lexema.toString());
									}
								}
							}else {
	...
	private Token processaNUM(char c, Token t) throws EOFException, IOException, ExcecaoLexica {
